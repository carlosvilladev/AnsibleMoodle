...
DIR=$HOME/Documents/UTB/ComputacionNube/Ansible/Ansible202/ansible002
...
$DIR/create_dockers.sh
#docker start server_task_02

ssh -o StrictHostKeyChecking=no root@server01 -p 2221 -i $DIR/key2.private hostname
ssh -o StrictHostKeyChecking=no root@server02 -p 2222 -i $DIR/key2.private hostname
ssh -o StrictHostKeyChecking=no root@server03 -p 2223 -i $DIR/key2.private hostname
